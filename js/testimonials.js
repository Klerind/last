...
function getData(data) {
  //converts data from json format to javascript object and saves it to a constsnt variable
  ...
  let rowData = [];
    ...
    function getData(data) {
      //converts data from json format to javascript object
       ...
       //converts javascript object to json format
       const jsonData = JSON.stringify(parsedData);
       //sends data to php/_saveClient.php file
    ...
    //gets data from json/inputs.json file and passes it to getData function
    getAjaxRequest("json/inputs.json",getData);
